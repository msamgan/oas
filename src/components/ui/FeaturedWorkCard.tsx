    ...
    return (
        <Link to={to} className="group block" aria-label={`${title} by ${author}`}>
            <Card variant="default" className="card" animationDelay={animationDelay} role="listitem" {...rest}>
                <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-[#f5f5f5] to-[#e8e8e8] after:absolute after:inset-0 after:bg-gradient-to-br after:from-[rgba(255,122,24,0.1)] after:to-[rgba(255,183,3,0.05)] after:opacity-0 after:transition-opacity after:duration-[400ms] after:ease-out after:content-[''] group-hover:after:opacity-100" />
