                ...
                <Container className="relative z-10">
                    <div className="mx-auto max-w-4xl">
                        ...
                        <div className="text-center">
                            ...
                            <div
                                className={`mx-auto mb-6 h-32 w-32 rounded-full bg-gradient-to-br from-[var(--color-accent)] via-[var(--color-accent-2)] to-[var(--color-accent)] shadow-[0_0_50px_rgba(255,122,24,0.4)] transition-all duration-1000 ${isVisible ? 'scale-100 opacity-100' : 'scale-75 opacity-0'}`}
                                style={{
                            ...
                            {/* Bio */}
                            <p
                                className={`mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-[var(--color-muted)] transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}
                        ...
                        {[
                            ...
                            >
                                ...
                                <div className="relative">
                                    ...
                                    <div className="text-xs font-bold tracking-wider text-[var(--color-muted)] uppercase">{stat.label}</div>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <Container>
                    ...
                    {artistWorks.length > 0 ? (
                        ...
                        <div className="rounded-[var(--radius)] border border-dashed border-white/[0.1] bg-white/[0.02] py-20 text-center">
                            <svg
                                className="mx-auto mb-4 h-16 w-16 text-[var(--color-muted)] opacity-40"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                ...
                <Container>
                    <div className="relative overflow-hidden rounded-[var(--radius)] border border-white/[0.08] bg-gradient-to-br from-[rgba(255,122,24,0.12)] via-[rgba(255,183,3,0.08)] to-transparent p-12 text-center shadow-[var(--shadow-2)]">
                        ...
                        <div className="relative z-10">
                            ...
                            <p
                                className="mx-auto mb-8 max-w-2xl animate-[fade-in-up_0.8s_ease-out] text-lg text-[var(--color-muted)]"
