...
const variants: Record<NonNullable<BadgeProps['variant']>, string> = {
    ...
    featured:
        'px-2.5 py-1 rounded-full bg-linear-to-r from-[var(--color-accent)] to-[var(--color-accent-2)] text-xs font-bold text-white shadow-lg animate-[float_6s_ease-in-out_infinite]',
    glow: 'px-2.5 py-1.5 rounded-full bg-black/4 border border-black/10 text-[var(--color-text)] text-xs font-bold animate-[glow_2s_ease-in-out_infinite]',
}
