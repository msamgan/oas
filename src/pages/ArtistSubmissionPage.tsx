    ...
    return (
        <main className="min-h-screen">
                ...
                <Container className="relative z-10">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <Heading as="h1" variant="hero" className="mb-5 animate-[fade-in-up_0.8s_ease-out_0.2s_both]">
                            Submit Your{' '}
                            <span className="relative inline-block animate-[gradient-shift_3s_ease-in-out_infinite] bg-linear-to-br from-accent to-accent-2 bg-clip-text text-transparent [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                                Artist Profile
                            </span>
                        </Heading>
                        <p className="text-muted animate-[fade-in-up_0.8s_ease-out_0.3s_both] text-lg leading-relaxed md:text-xl">
                            Share your details for admin review. Once approved, you'll receive sign-in credentials to manage your profile and
                ...
                <Container>
                    <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                        ...
                        <Form ref={formRef} onSubmit={handleSubmit} aria-labelledby="artist-submit-title">
                            <div className="mb-6">
                                ...
                                <p className="text-muted mt-2 text-sm">
                                    Fields marked <Required /> are required. We'll review your submission and get back to you within 3–5 business days.
                                </p>
                            </div>
                            ...
                            <div className="space-y-5">
                                ...
                                {/* Consent */}
                                <div className="flex items-start gap-2 rounded-sm border border-white/10 bg-white/2 p-4">
                                    <label className="text-muted hover:text-text flex cursor-pointer items-start gap-3 text-sm transition-colors">
                                        <input
                                            required
                                            type="checkbox"
                                            name="consent"
                                            className="accent-accent hover:border-accent bg-surface mt-0.5 h-4 w-4 cursor-pointer rounded border-white/20 transition-all"
                                        />
                                        <span>
                                            I confirm the information provided is accurate and I agree to be contacted by Orange Art Studio regarding my
                                            submission.
                                        </span>
                                    </label>
                                </div>
                        ...
                        <aside ref={sidebarRef} className="animate-[fade-in-up_0.7s_ease-out_0.6s_both] space-y-6 opacity-0">
                            ...
                            <div className="group rounded-(--radius) border border-white/10 bg-linear-to-br from-surface to-[rgba(255,122,24,0.02)] p-6 shadow-(--shadow-1) transition-all duration-500 hover:border-[rgba(255,122,24,0.2)] hover:shadow-[0_20px_60px_rgba(255,122,24,0.15)]">
                                ...
                                <ol className="text-muted space-y-4 text-sm">
                                    <li className="flex items-start gap-3">
                                        <span className="text-accent shrink-0 flex h-6 w-6 items-center justify-center rounded-full bg-[rgba(255,122,24,0.15)] text-xs font-bold">
                                            1
                                        </span>
                                        <div>
                            ...
                            {/* Requirements Card */}
                            <div className="group rounded-(--radius) border border-white/10 bg-linear-to-br from-surface to-[rgba(255,183,3,0.02)] p-6 shadow-(--shadow-1) transition-all duration-500 hover:border-[rgba(255,183,3,0.2)] hover:shadow-[0_20px_60px_rgba(255,183,3,0.15)]">
                                <h3 className="text-text mb-4 flex items-center gap-2 text-lg font-bold">
                            ...
                            {/* Privacy Note */}
                            <div className="rounded-sm border border-white/6 bg-white/3 p-4">
                                <p className="flex items-start gap-2 text-xs leading-relaxed text-white/60">
                                    <svg
                                        className="text-accent shrink-0 mt-0.5 h-4 w-4"
                                        viewBox="0 0 24 24"
                                        fill="none"
                                        stroke="currentColor"
                                    >
            ...
            <Section id="submit-cta" padding="md">
                <Container>
                    <div className="relative animate-fade-in-up overflow-hidden rounded-(--radius) border border-[rgba(255,122,24,0.2)] bg-[linear-gradient(135deg,rgba(255,122,24,0.1)_0%,rgba(255,183,3,0.05)_100%)] p-10 text-center shadow-[0_20px_60px_rgba(255,122,24,0.1),var(--shadow-2)] md:p-12 lg:p-16">
                        <div className="relative z-2">
                            <h2 className="m-0 mb-4 bg-linear-to-br from-text to-accent bg-clip-text text-[clamp(28px,5vw,42px)] font-black tracking-[-0.5px] text-transparent [-webkit-background-clip:text] [-webkit-text-fill-color:transparent]">
                                Questions About Submission?
                            </h2>
                            <p className="text-muted mx-auto mb-8 max-w-[60ch] text-[clamp(16px,2.2vw,18px)] leading-[1.6]">
                                Our team is here to help guide you through the process. Reach out if you have any questions about joining our
                                artist community.
                            </p>
