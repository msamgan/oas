...
function StatLabel({ className, children, ...rest }: StatLabelProps) {
    return (
        <div
            className={cn(
                'stat-label text-[15px] font-semibold tracking-[0.8px] text-[var(--color-muted)] uppercase transition-colors duration-300 ease-out hover:text-[var(--color-text)]',
                className,
            )}
            {...rest}
        >
