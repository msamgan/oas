...
const variants: Record<NonNullable<HeadingProps['variant']>, string> = {
    hero: 'text-[clamp(40px,6vw,72px)] leading-[1.05] tracking-[-0.5px] my-4 bg-linear-to-br from-text to-accent bg-clip-text text-transparent [-webkit-background-clip:text] [-webkit-text-fill-color:transparent] bg-[length:200%_200%]',
