...
function ArtistDetailsPage() {
    ...
    return (
        <main className="min-h-screen">
                ...
                <Container className="relative z-10">
                    <div className="mx-auto max-w-4xl">
                        ...
                        <div className="text-center">
                            ...
                            <div
                                className={`mx-auto mb-6 h-32 w-32 rounded-full bg-gradient-to-br from-[var(--color-accent)] via-[var(--color-accent-2)] to-[var(--color-accent)] shadow-[0_0_50px_rgba(255,122,24,0.4)] transition-all duration-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}
                                style={{
                            ...
                            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '0.3s' }}>
                                <p className="mb-2 text-lg font-semibold text-[var(--color-accent)]">{artist.genre}</p>
                                {artist.location && (
                                    <p className="mb-1 flex items-center justify-center gap-2 text-[var(--color-muted)]">
                            ...
                            {/* Bio */}
                            <p
                                className={`mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-[var(--color-muted)] transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
            ...
            {/* Statistics Section */}
            <Section padding="md" className="border-y border-white/[0.06] bg-gradient-to-b from-transparent to-white/[0.02]">
                <Container>
                    <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
                        {[
                            ...
                            <div
                                key={i}
                                className={`group relative overflow-hidden rounded-[var(--radius)] border border-white/[0.06] bg-gradient-to-br from-white/[0.03] to-white/[0.01] p-6 text-center backdrop-blur-sm transition-all duration-500 hover:border-[var(--color-accent)]/30 hover:bg-white/[0.06] hover:shadow-[0_8px_30px_rgba(255,122,24,0.15)] ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                                style={{ transitionDelay: stat.delay }}
                            >
                                {/* Hover Shimmer Effect */}
                                <div className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/[0.1] to-transparent transition-transform duration-700 group-hover:translate-x-full" />
            ...
            <Section id="works" padding="lg">
                <Container>
                    ...
                    {artistWorks.length > 0 ? (
                        ...
                        <div className="rounded-[var(--radius)] border border-dashed border-white/[0.1] bg-white/[0.02] py-20 text-center">
                            <svg className="mx-auto mb-4 h-16 w-16 text-[var(--color-muted)] opacity-40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <p className="text-lg text-[var(--color-muted)]">No artworks listed yet. Check back soon!</p>
                        </div>
                    )}
                </Container>
            </Section>
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                            {relatedArtists.map((relatedArtist, i) => (
                                ...
                                >
                                    ...
                                    <div className="relative">
                                        {/* Avatar */}
                                        <div className="mb-4 h-20 w-20 rounded-full bg-gradient-to-br from-[var(--color-accent)] to-[var(--color-accent-2)] shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:shadow-[0_0_30px_rgba(255,122,24,0.5)]" />
                                        ...
                                        <p className="mb-3 text-sm text-[var(--color-muted)]">{relatedArtist.genre}</p>
                ...
                <Container>
                    <div className="relative overflow-hidden rounded-[var(--radius)] border border-white/[0.08] bg-gradient-to-br from-[rgba(255,122,24,0.12)] via-[rgba(255,183,3,0.08)] to-transparent p-12 text-center shadow-[var(--shadow-2)]">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="mx-auto mb-8 max-w-2xl text-lg text-[var(--color-muted)] animate-[fade-in-up_0.8s_ease-out]" style={{ animationDelay: '0.1s' }}>
                                Get in touch to discuss commissions, exhibitions, or collaborations with this talented artist.
                            </p>
                            <div className="flex flex-wrap items-center justify-center gap-3.5 animate-[fade-in-up_0.8s_ease-out]" style={{ animationDelay: '0.2s' }}>
                                <Button asLink to="/contact">Contact Artist</Button>
                                <Button variant="secondary" asLink to="/artists">
                                    Browse More Artists
                                </Button>
                            </div>
