...
const variants: Record<NonNullable<ButtonProps['variant']>, string> = {
    ...
    ghost:
        'appearance-none cursor-pointer py-3.5 px-4.5 rounded-[var(--radius)] font-extrabold tracking-[0.2px] transition-all duration-200 ease-out text-[var(--color-text)] hover:bg-white/5',
}
